...
tid2item_id_path = './cloth_sport/sum_data/item_id2tid/cloth_sport_tid2item_id.json'
...
def main():
    # Model paths
    ckpts = [
        "../sft_ckpts/grlm_crossdomain_cloth_sport/",
        ]
    ...
    for ckpt in ckpts:
        ...
        # Test data path
        test_file = "../LlamaFactory/data/grlm_cross_domain/amazon_cloth_sport_sft_data_rec.json"
        ...
        bac = ckpt.replace("/","_")
        output_file = f"./cloth_sport/rec_res/cloth_sport_eval_info_{bac}.json"
        print(f"\nSaving detailed results to: {output_file}")
        with open(output_file, 'w', encoding='utf-8') as f:
            json.dump(all_results, f, ensure_ascii=False, indent=2)
        
        # Save recall results
        recall_file = f"./cloth_sport/rec_res/cloth_sport_recall_results_{bac}.json"
