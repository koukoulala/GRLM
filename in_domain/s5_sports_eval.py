...
tid2item_id_path = './sports/sum_data/item_id2tid/sports_tid2item_id.json'
...
def main():
    # Model paths
    ckpts = [
        "../sft_ckpts/grlm_indomain_sports/",
        ]
    ...
    for ckpt in ckpts:
        ...
        # Test data path
        test_file = "../LlamaFactory/data/grlm_in_domain/amazon_sports_sft_data_rec.json"
        ...
        bac = ckpt.replace("/","_")
        output_file = f"./sports/rec_res/sports_eval_info.json"
        print(f"\nSaving detailed results to: {output_file}")
        with open(output_file, 'w', encoding='utf-8') as f:
            json.dump(all_results, f, ensure_ascii=False, indent=2)
        
        # Save recall results
        recall_file = f"./sports/rec_res/sports_recall_results.json"
