...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir", type=str,
        default="/cosmos/projects/Recommendations/PartnerData/Pipelines/OneRec/"
                "Data/LLMTrainingData/eval_results/ying_checkpoint_14932/",
    ...
    parser.add_argument(
        "--item_file", type=str,
        default="/cosmos/projects/Recommendations/PartnerData/Pipelines/OneRec/"
                "Data/LLMTrainingData/raw_data/merged_clean_item2.json",
        help="Path to merged_clean_item JSON for looking up product titles",
    )
    parser.add_argument(
