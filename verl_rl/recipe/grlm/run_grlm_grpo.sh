...
# ============================================================================
# Cluster Configuration (use environment variables or defaults)
# ============================================================================
# For single-node setup, just set N_NODES and N_GPUS directly
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-"grpo_exper"}
...
python3 -u -m recipe.grlm.main_grlm_ppo \
    ...
    data.custom_cls.path=$SCRIPT_DIR/grlm_recipe.py \
    ...
    custom_reward_function.path=$SCRIPT_DIR/grlm_recipe.py \
